<?php
	...
	$Translation['and'] = "And";
	$Translation['or'] = "Or";
	$Translation['Igual a'] = "Igual a";
	$Translation['No igual a'] = "No igual a";
	$Translation['Mayor que'] = "Mayor que";
	$Translation['Mayor qué o igual a'] = "Mayor qué o igual a";
	$Translation['Menor que'] = "Menor que";
	$Translation['Menor que o igual a'] = "Menor que o igual a";
	$Translation['Me gusta'] = "Me gusta";
	$Translation['No me gusta'] = "No me gusta";
	$Translation['Está vacío'] = "Está vacío";
	$Translation['No esta vacío'] = "No esta vacío";
