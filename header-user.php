...
<head>
	...
	<title>IE 2048 JOSÉ CARLOS MARIÁTEGUI <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
    ...
    <div class="sidebar-wrapper">
            <div class="logo">
                <a href="http://www.creative-tim.com" class="simple-text">
                    IE 2048 JOSÉ CARLOS MARIÁTEGUI
                </a>
            </div>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Información General</a>
                </div>
              ...
              <li><a href="<?php echo PREPEND_PATH; ?>membership_profile.php"><i class="fa fa-user"></i> <strong>Mi Perfil</strong> </a></li>
              <!--login/logout area starts-->
              <li>
               <?php if(getLoggedAdmin()){ ?>
               <a href="<?php echo PREPEND_PATH; ?>admin/pageHome.php" class="btn btn-danger navbar-btn btn-sm hidden-xs"><i class="fa fa-cog"></i> <strong> Administrar<?php echo $Translation[' ']; ?></strong></a>
            ...
            <li class="divider"></li>
            <li><a class="btn navbar-btn btn-warning" href="<?php echo PREPEND_PATH; ?>index.php?signOut=1"><i class="fa fa-power-off"></i> <strong style="color:black">Cerrar <?php echo $Translation['']; ?></strong> </a></li>
          </ul>
        </li>
          </ul>
                        </li>
