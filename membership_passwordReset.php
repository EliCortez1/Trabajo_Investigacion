					...
					<form method="post" action="membership_passwordReset.php">
						...
						<div class="row">
							<div class="col-sm-offset-3 col-sm-6">
								<button class="btn btn-primary btn-lg btn-block" value="changePassword" id="changePassword" type="submit" name="changePassword" value="1">Enviar<?php echo $Translation['']; ?></button>
							</div>
						</div>
